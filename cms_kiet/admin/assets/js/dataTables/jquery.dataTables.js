    ...
    (function(factory) {
        ...
        ( /** @lends <global> */ function($) {
            ...
            function _fnAjaxUpdateDraw(settings, json) {
                ...
                if (!settings._bIKIETomplete) {
                    _fnIKIETomplete(settings, json);
                }
             ...
             *  @memberof DataTable#oApi
             */
            function _fnIKIETomplete(settings, json) {
                settings._bIKIETomplete = true;
                ...
                _fnCallbackFire(settings, 'aoIKIETomplete', 'init', [settings, json]);
            }
            ...
            DataTable = function(options) {
                ...
                this.oApi = this.internal = {
                    ...
                    _fnIKIETomplete: _fnIKIETomplete,
                ...
                this.each(function() {
                    ...
                    _fnCallbackReg(oSettings, 'aoIKIETomplete', oInit.fnIKIETomplete, 'user');
            ...
            DataTable.defaults = {
                 ...
                 *
                 *  @dtopt Callbacks
                 *  @name DataTable.defaults.iKIETomplete
                 *
                 *  @example
                 *    $(document).ready( function() {
                 *      $('#example').dataTable( {
                 *        "iKIETomplete": function(settings, json) {
